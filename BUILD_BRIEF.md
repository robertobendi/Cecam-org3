...
You are building the public face of **robertobendi/Cecam-org3** (modeled after https://www.cecam.org/). Target: GitHub
...
user can log into the local admin later):
    ...
    ADMIN_PASSWORD="bis-0rBz2mHZxEKEiM" \
    ADMIN_NAME="Admin" \
    SITE_NAME="Cecam Org3" \
...
spawns a focused fix session for anything that didn't make it. You do not
need to loop; the orchestrator does.
